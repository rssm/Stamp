...
class VirtualObjectInteraction: NSObject, UIGestureRecognizerDelegate {
     ...
     */
    var selectedObject: ARStamp?
    
    /// The object that is tracked for use by the pan and rotation gestures.
    private var trackedObject: ARStamp? {
        didSet {
    ...
    /// - Tag: TouchTesting
    private func objectInteracting(with gesture: UIGestureRecognizer, in view: ARSCNView) -> ARStamp? {
    ...
    func translate(_ object: ARStamp, basedOn screenPos: CGPoint, infinitePlane: Bool, allowAnimation: Bool) {
